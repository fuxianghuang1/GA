...
def parse_opt():
    ...
    parser.add_argument('--comment', type=str, default='css3d')# mitstates fashion200k css3d
    parser.add_argument('--dataset', type=str, default='css3d')
    parser.add_argument('--dataset_path', type=str, default='./dataset/CCS')

    parser.add_argument('--model', type=str, default='tirg')#composeAE  tirg
    ...
    parser.add_argument('--choose_device', type=int, default=0)
    ...
    parser.add_argument('--model_checkpoint', type=str, default='./TIRG+GA_css.pth')
...
def train_loop(opt, loss_weights, logger, trainset, testset, model, optimizer):
    ...
    while  epoch < opt.epoch: #while it < opt.num_iters:
        ...
        if epoch % 1 == 0:
            ...
            is_best = Rmean > Rmean_max
            if is_best:
                Rmean_max = Rmean
                print ('save model and Rmean_max = ', round(Rmean_max, 4))
                print(tests)
